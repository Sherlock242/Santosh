...
import { getGalleryPosts, deleteUserAccount, deletePost } from '@/app/actions';
...
interface GalleryClientPageProps {
    initialPosts: GalleryEmoji[];
    initialProfileUser: ProfileUser;
    initialSupporterCount: number;
    initialSupportingCount: number;
    initialSupportStatus: 'approved' | 'pending' | null;
    viewingUserId: string;
    isOwnProfile: boolean;
    canViewContentInitially: boolean;
}
...
export default function GalleryClientPage({
    ...
    initialSupportingCount,
    initialSupportStatus,
    viewingUserId,
    isOwnProfile,
    canViewContentInitially
    ...
    const [canViewContent, setCanViewContent] = useState(canViewContentInitially);
