...
import { getNotifications, respondToSupportRequest } from '../app/actions';
...
export default function NotificationsClientPage({ initialNotifications }: { initialNotifications: Notification[] }) {
  const { user } = useAuth();
